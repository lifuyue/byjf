...
function showContent() {
    ...
    // 设置正确的链接
    if(policyCard) policyCard.href = '学校保研政策.html';
    if(rankingCard) rankingCard.href = '专业排名（教师端）.html';
    //if(planCard) planCard.href = '我的保研计划.html';
    //if(competitionCard) competitionCard.href = '新增竞赛成绩.html';
}
